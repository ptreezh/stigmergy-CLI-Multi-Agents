...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("💡 原始功能: python smart_qodercli.py '参数'")
        print("🤖 智能路由示例:")
        print("    python smart_qodercli.py '用claude写代码'")
        print("    python smart_qodercli.py '用gemini写代码'")
        print("    python smart_qodercli.py '用kimi写代码'")
        print("    python smart_qodercli.py '用qwen写代码'")
        print("    python smart_qodercli.py '用ollama写代码'")
        print("    python smart_qodercli.py '用codebuddy写代码'")
        print("    python smart_qodercli.py '用qodercli写代码'")
        print("    python smart_qodercli.py '用iflow写代码'")
        return 0
