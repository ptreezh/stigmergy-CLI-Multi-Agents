...
if [[ -z "$USER_INPUT" ]]; then
    echo "🎯 智能claude路由器 - Bash版 - 增强版"
    echo "💡 原始功能: ./smart_claude.sh '参数'"
    echo "🤖 智能路由示例:"
    echo "    ./smart_claude.sh '用claude写代码'"
    echo "    ./smart_claude.sh '用gemini写代码'"
    echo "    ./smart_claude.sh '用kimi写代码'"
    echo "    ./smart_claude.sh '用qwen写代码'"
    echo "    ./smart_claude.sh '用ollama写代码'"
    echo "    ./smart_claude.sh '用codebuddy写代码'"
    echo "    ./smart_claude.sh '用qodercli写代码'"
    echo "    ./smart_claude.sh '用iflow写代码'"
    exit 0
fi
