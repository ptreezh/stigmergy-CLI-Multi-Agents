...
def copy_adapter_file():
    ...
    try:
        ...
        # 创建全局Cross-CLI文档
        create_global_cross_cli_documentation(CLAUDE_CONFIG_DIR)
...
def create_global_cross_cli_documentation(config_dir):
    """创建全局Cross-CLI通信文档"""
    try:
        doc_content = """# Claude CLI 跨CLI通信指南
...
"""
        ...
        # 如果存在claude.md文件，则在末尾追加Cross-CLI通信提示
...
"""
            ...
            print("[OK] 在CLAUDE.md末尾追加Cross-CLI通信提示")
