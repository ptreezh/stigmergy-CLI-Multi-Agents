// Gemini CLI ResumeSession Integration
...
class GeminiHistoryHandler {
  ...
  async handleCommand(input, session) {
    ...
    try {
      ...
      const result = await this.historyQuery.queryHistory(options, 'D:\stigmergy-CLI-Multi-Agents\test-final-verification-2');
...
if (typeof geminiCLI !== 'undefined') {
  ...
  const cmdName = 'stigmergy-resume'.replace(/^\//, '');
