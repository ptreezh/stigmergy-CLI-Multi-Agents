...
if "%USER_INPUT%"=="" (
    echo 🎯 智能gemini路由器 - 增强版
    echo 💡 原始功能: gemini [参数]
    echo 🤖 智能路由示例:
    echo     智能gemini.bat 用claude|anthropic
    echo     智能gemini.bat 用gemini|google|谷歌
    echo     智能gemini.bat 用kimi|月之暗面|moonshot
    echo     智能gemini.bat 用qwen|通义|阿里
    echo     智能gemini.bat 用ollama|本地|离线
    echo     智能gemini.bat 用codebuddy|代码助手|编程
    echo     智能gemini.bat 用qodercli|代码生成|编程
    echo     智能gemini.bat 用iflow|智能|助手|心流
