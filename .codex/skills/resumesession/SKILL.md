...
Cross-CLI session recovery and history management skill for Codex CLI.

## Description

This skill enables Codex CLI to:
...
Bash("stigmergy resume --cli codex")
...
Bash("stigmergy resume --cli codex --today")
