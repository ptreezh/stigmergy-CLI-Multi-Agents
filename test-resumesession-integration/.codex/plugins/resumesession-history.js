...
// Project: D:\stigmergy-CLI-Multi-Agents\test-resumesession-integration
      ...
      for (const file of files) {
        if (file.endsWith('.jsonl')) {
          try {
            ...
            if (firstUserMsg) {
              let content = firstUserMsg.content || firstUserMsg.message || firstUserMsg.text;
...
class HistoryFormatter {
  formatSummary(sessions) {
    ...
    response += '💡 **使用:** /history --cli <工具> | --search <�? | --format timeline';
    return response;
  }
...
class CodexHistoryHandler {
  ...
  async processCommand(input, session) {
    ...
    try {
      ...
      const result = this.historyQuery.queryHistory(options, 'D:\stigmergy-CLI-Multi-Agents\test-resumesession-integration');
