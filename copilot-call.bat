...
REM 检查参数
if "%~1"=="" (
    echo 用法: copilot-call ^<cli_name^> [arguments...]
    echo 示例: copilot-call claude --version
    echo.
    echo 已安装的CLI工具:
...
echo 请使用以下工具之一: claude, gemini, qwen, iflow, codebuddy, codex
exit /b 1