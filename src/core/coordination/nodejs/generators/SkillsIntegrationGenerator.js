    ...
    switch (cliName.toLowerCase()) {
      case "claude":
        return {
          ...
          content: this.generateClaudeSkillsIntegration(
            currentProjectPath,
            skillsDir,
          ),
        };
      case "gemini":
        return {
          ...
          content: this.generateGeminiSkillsIntegration(
            currentProjectPath,
            skillsDir,
          ),
        };
      case "qwen":
        return {
          ...
          content: this.generateQwenSkillsIntegration(
            currentProjectPath,
            skillsDir,
          ),
        };
      case "codebuddy":
        return {
          ...
          content: this.generateCodeBuddySkillsIntegration(
            currentProjectPath,
            skillsDir,
          ),
        };
      case "codex":
        return {
          ...
          content: this.generateCodexSkillsIntegration(
            currentProjectPath,
            skillsDir,
          ),
        };
      case "qodercli":
        return {
          fileName: "skills-extension.js",
          content: this.generateQoderCliSkillsIntegration(
            currentProjectPath,
            skillsDir,
          ),
        };
      default:
        return {
          fileName: "skills-hook.js",
          content: this.generateGenericSkillsIntegration(
            cliName,
            currentProjectPath,
            skillsDir,
          ),
