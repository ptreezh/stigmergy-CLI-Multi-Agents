...
class TestSuiteRunner {
  ...
  printSummary() {
    ...
    for (const [key, result] of Object.entries(this.results)) {
      ...
      console.log(
        `${icon} ${result.name}: ${result.passed} passed, ${result.failed} failed`,
      );
    ...
    if (totalFailed === 0) {
      ...
      console.log(
        "  [OK] Module integration tests passed (7 integration tests)",
      );
      console.log(
        "  [OK] Existing functionality protection passed (10 regression tests)",
      );
