...
class StigmergySkillManager {
  ...
  async sync() {
    ...
    try {
      ...
      console.log(`\n[OK] Sync completed:`);
      console.log(
        `   - Skills copied: ${copyResults.copied} to ${copyResults.targets} CLI directory(ies)`,
      );
  ...
  async syncSkillFiles(skills) {
    ...
    const cliSkillDirs = [
      ...
      {
        name: "CodeBuddy",
        path: path.join(os.homedir(), ".codebuddy", "skills"),
      },
      {
        name: "Gemini",
        path: path.join(os.homedir(), ".config", "gemini", "skills"),
      },
      ...
      {
        name: "Codex",
        path: path.join(os.homedir(), ".config", "codex", "skills"),
      },
      { name: "Kode", path: path.join(os.homedir(), ".kode", "skills") },
      {
        name: "KiloCode",
        path: path.join(os.homedir(), ".kilocode", "skills"),
      },
      {
        name: "OpenCode",
      ...
      try {
        ...
        for (const skill of skills) {
          ...
          try {
            ...
            if (process.env.DEBUG === "true") {
              console.log(
                `[DEBUG] Skipped ${skillName} for ${cliDir.name}: ${err.message}`,
              );
            }
          }
        }
