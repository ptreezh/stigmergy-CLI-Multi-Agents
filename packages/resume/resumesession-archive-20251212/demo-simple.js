...
console.log('🚀 ShareMem Demo - Cross-CLI Session Recovery\n');
console.log('ShareMem 允许在任何项目目录下初始化跨CLI会话恢复功能。\n');
...
console.log('🔧 使用流程:');
console.log('1. 在任何项目目录下运行: sharemem init');
...
console.log('');
console.log('? Select CLI tools to integrate with ShareMem:');
...
console.log('');
console.log('🎉 ShareMem initialization completed successfully!\n');
...
console.log('现在你可以在任何项目中使�?resumesession 来管理跨CLI会话了！');
