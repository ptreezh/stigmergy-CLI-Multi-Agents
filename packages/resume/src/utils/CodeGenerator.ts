...
const historyCommand = {
  ...
  async execute(args, workflow) {
    // 实现history命令逻辑
    return '🔍 IFlow CLI ResumeSession history integration...';
  }
};
...
const codebuddyHistory = {
  async handleSlashCommand(input, context) {
    ...
    // 实现history逻辑
    return {
      text: '🔍 CodeBuddy CLI ResumeSession history integration...',
      suggestions: ['/history --help']
    };
  }
};
...
const qoderHistory = {
  ...
  handler: async (input, context) => {
    ...
    return '🔍 QoderCLI ResumeSession history integration...';
  }
};
...
const codexHistory = {
  processCommand: async (input, session) => {
    ...
    // 实现history逻辑
    return {
      response: '🔍 Codex CLI ResumeSession history integration...',
      suggestions: ['/history --help']
    };
  }
};
