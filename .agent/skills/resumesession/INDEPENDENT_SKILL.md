...
cp independent-resume.js C:\Users\WIN10/.local/bin/resume-session

# Make it executable (Linux/Mac)
chmod +x C:\Users\WIN10/.local/bin/resume-session
...
# Or use full path
node C:\Users\WIN10/.claude/skills/resumesession/independent-resume.js
```
...
// If using full path
Bash("node C:\Users\WIN10/.claude/skills/resumesession/independent-resume.js")
```
...
cd C:\Users\WIN10/projects/my-app
resume-session
...
**Configuration Management**: CLI paths and detection are managed by stigmergy. The tool reads configuration from `C:\Users\WIN10/.stigmergy/config.json`. Must run stigmergy CLI initialization before using this tool.
