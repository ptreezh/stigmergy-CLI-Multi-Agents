...
```bash
# 创建可执行链接
ln -s $(pwd)/independent-resume.js C:\Users\WIN10/.local/bin/resume-session
...
- 自动读取 `C:\Users\WIN10/.stigmergy/config.json`
- 使用 stigmergy 的扫描结果
- 提供最准确的 CLI 检测
- 支持自定义 CLI 路径和多个实例
...
**Linux/Mac:**
- `C:\Users\WIN10/.cli-name/projects/`
- `C:\Users\WIN10/.config/cli-name/projects/`

**Windows:**
- `C:\Users\WIN10/AppData/Roaming/cli-name/projects/`
...
cd C:\Users\WIN10/projects/another-project
resume-session
```
