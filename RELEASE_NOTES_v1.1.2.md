# Stigmergy CLI v1.1.2 Release Notes
...
- **Missing method calls**: Fixed calls to non-existent methods (routePrompt, prepareToolArguments)
...
- Corrected tool argument generation logic
...
## 📊 Version Information
- **Previous Version**: 1.1.1 (had critical bugs)
- **New Version**: 1.1.2 (additional bug fixes and stability improvements)
- **Type**: Patch Release
